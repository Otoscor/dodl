  ...
  return (
    <div className="pb-44">
          ...
          {cart.items.map((item) => (
            <div key={item.id} className="flex gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[13px] text-text-primary truncate">{item.product_name}</p>
                {item.option_summary && (
      ...
      <section className="px-4 py-4 border-b border-border-subtle">
        ...
        <div className="space-y-3">
          <input
            ...
            className="w-full bg-surface-elevated border border-border-subtle rounded-xl px-4 py-3 text-[14px] text-text-primary placeholder:text-text-quaternary outline-none focus:border-action-primary transition-colors"
          />
          <input
            type="tel"
      ...
      <section className="px-4 py-4 border-b border-border-subtle space-y-2 text-[13px]">
        <h2 className="text-[14px] font-medium text-text-primary mb-3">결제 금액</h2>
      ...
      <section className="px-4 py-4">
        <div className="flex justify-between items-center">
          <span className="text-[13px] text-text-secondary">가상 지갑 잔액</span>
          <span className={`font-mono text-[14px] font-medium ${isBalanceSufficient ? "text-accent-green" : "text-accent-red"}`}>
